...
router.post("/", async (req, res, next) => {
  ...
  // res.sendFile(image);
  let { Goods_no, Goods_name, inv, price, Goods_img_src } = req.body;
  let selectGoodsTbQuery = "SELECT * FROM goods_tb WHERE Goods_no = ? ";
  let selectGoodsTbParams = [Goods_no];
  try {
